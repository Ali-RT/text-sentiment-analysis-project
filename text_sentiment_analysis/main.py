...
def train_sentiment_network():
    reviews = read_file("./text_sentiment_analysis/reviews.txt")
    labels = [label.upper() for label in read_file("./text_sentiment_analysis/labels.txt")]
